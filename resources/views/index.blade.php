    ...
    <div class="row mb-3">
        <div class="col-lg-12 margin-tb">
            <div class="text-center">
                ...
                <a class="btn btn-success" href="{{ route('file.create') }}" title="Upload files"> <i class="fas fa-upload fa-2x"></i>
                </a>
            </div>
        </div>
    </div>
        ...
        <table class="table table-bordered table-responsive-lg thead-dark text-center">
            ...
            <tbody>  
                ...
                <tr>
                    ...
                    <td><img src="images/{{ $project->filename }}" width='80'>
                  
                    <td>{{ date_format($project->created_at, 'jS M Y') }}</td>
                    <td>
                        <form action="{{ route('file.destroy', $project->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
